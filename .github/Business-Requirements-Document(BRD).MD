...
- Create BilledPipelineSM Semantic Model in OCT-Dev workspace using the above lakehouse & shortcuts created
- Identify eligible date tables and set them as official date tables in the model
